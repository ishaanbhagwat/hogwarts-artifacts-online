...
class ArtifactControllerTest {
    ...
    void setUp() {
        ...
        a1.setDesc("A Deluminator is a device invented by Albus Dumbledore that resembles a cigarette lighter. It is used to remove or absorb (as well as return) the light from any light source to provide cover to the user.");
        ...
        a2.setDesc("An invisibility cloak is used to make the wearer invisible.");
        ...
        a3.setDesc("The Elder Wand, known throughout history as the Deathstick or the Wand of Destiny, is an extremely powerful wand made of elder wood with a core of Thestral tail hair.");
        ...
        a4.setDesc("A magical map of Hogwarts created by Remus Lupin, Peter Pettigrew, Sirius Black, and James Potter while they were students at Hogwarts.");
        ...
        a5.setDesc("A goblin-made sword adorned with large rubies on the pommel. It was once owned by Godric Gryffindor, one of the medieval founders of Hogwarts.");
        ...
        a6.setDesc("he Resurrection Stone allows the holder to bring back deceased loved ones, in a semi-physical form, and communicate with them.");
    ...
    @Test
    void testAllArtifactSuccess() throws Exception {
        //Given
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        savedArtifact.setDesc("A Remembrall was a magical large marble-sized glass ball that contained smoke which turned red when its owner or user had forgotten something. It turned clear once whatever was forgotten was remembered.");
        ...
        this.mockMvc.perform(post("/api/v1/artifacts").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.data.description").value(savedArtifact.getDesc()))
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        updatedArtifact.setDesc("A new description.");
        ...
        this.mockMvc.perform(put("/api/v1/artifacts/1250808601744904192")
                ...
                .andExpect(jsonPath("$.data.description").value(updatedArtifact.getDesc()))
